...
Original file is located at
    https://colab.research.google.com/drive/1sTFVpTVuUIk0Ixxa2dp8og7ur7mpbzpQ
"""
...
jovian.set_colab_id('1sTFVpTVuUIk0Ixxa2dp8og7ur7mpbzpQ')
...
for images, labels in train_dl:
    ...
    print(out.shape)
    # pic = out[0].data.cpu().numpy()
    # pic = np.ascontiguousarray(pic.transpose(1,2,0))
    # print(pic.shape)
