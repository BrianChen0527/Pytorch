...
Original file is located at
    https://colab.research.google.com/drive/1TlthqD_ItrBvdvFdOORTASFyJRYz29df
"""
...
import jovian
jovian.set_project('06b-anime-dcgan')
jovian.set_colab_id('1TlthqD_ItrBvdvFdOORTASFyJRYz29df')
...
generator = nn.Sequential(
    ...
    # We pass in an image with 128 channels of 1 by 1 pixels, and it's up to the generator to use 
    # deconvolution (convTranspos2d) to generate 64 by 64 images with 3 channels (RGB) 
