...
Original file is located at
    https://colab.research.google.com/drive/1S83RTTP3Mpi_XejigU3pdnaAWPg_-eM3
"""
...
jovian.set_colab_id('1S83RTTP3Mpi_XejigU3pdnaAWPg_-eM3')
...
simple_model = nn.Sequential(
    # stride: how many px you move your kernel each step
    # padding: how many px you pad around yourn image
...
class Cifar10CnnModel(ImageClassificationBase):
    def __init__(self):
        ...
        self.network = nn.Sequential(
            ...
            nn.Flatten(), # flattens image into 1D tensor (256*4*4) 
